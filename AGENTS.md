...
- Mission packs: 001–040 basics, 081–100 media, 111–113+115+116+119+121–123+125–128 finale arc,
  ...
  terminal art, 181–190 packets/sniffers, 191–200 artifacts, 201–210 performance, 211–220 depth
...
- **Depth pack (211–220)**: ECDH (toy curve over F_97), event loop, hand-written JSON parser,
  DEFLATE inflate (stored + fixed Huffman), LSM replay, Raft journal, FIR/IIR, assembler (102-ISA),
  JIT trace, ChaCha20. References in `sol/deep.go`, tested via `TestMission211_220`; data generated
  by a one-off generator (not committed). 214/220 independently verified with `zlib`/`openssl`.
